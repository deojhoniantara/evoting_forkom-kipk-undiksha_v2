...
<div class="space-y-6 max-w-2xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-l-4 @if($agenda->status=='draft') border-gray-300 @elseif($agenda->status=='ongoing') border-yellow-400 @else border-green-500 @endif">
        ...
        <a href="{{ route('admin.candidates.by_agenda', $agenda->id) }}" class="bg-primary hover:bg-primary/90 text-white px-6 py-2 rounded-xl font-bold shadow flex items-center gap-2 transition hover:scale-105">
    ...
    <div class="text-center text-gray-400 py-8 flex flex-col items-center gap-2">
        <span class="text-5xl"><svg class='w-10 h-10' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M5.121 17.804A9 9 0 1112 21a9 9 0 01-6.879-3.196z'/><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M15 11a3 3 0 11-6 0 3 3 0 016 0z'/></svg></span>
