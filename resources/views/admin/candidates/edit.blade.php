...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Kandidat</h1>
                ...
                <div class="space-y-6">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="w-24 h-24 rounded-full overflow-hidden bg-gray-100">
                                <img id="photo-preview" 
                                     src="{{ $candidate->photo ? asset('storage/images/' . $candidate->photo) : asset('storage/images/default-avatar.png') }}" 
                                     alt="{{ $candidate->name }}" 
                    ...
                    <div>
                        ...
                        <textarea name="mission" 
                                  ...
                                  class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-primary focus:border-primary sm:text-sm"
                                  required
                                  placeholder="Pisahkan setiap misi dengan baris baru">{{ old('mission', $candidate->mission) }}</textarea>
